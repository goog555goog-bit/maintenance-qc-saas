        ...
        <table className="w-full text-left">
          ...
          <tbody>
            <tr className="border-b border-slate-100 hover:bg-slate-50">
              <td className="p-4 text-sm text-slate-800">1 ต.ค. 2023 - 08:00</td>
              <td className="p-4 text-sm font-bold text-slate-800">5.0</td>
              <td className="p-4 text-sm text-slate-600">ผู้ดูแลระบบ 1</td>
            </tr>
            <tr className="border-b border-slate-100 hover:bg-slate-50">
              <td className="p-4 text-sm text-slate-800">1 ก.ย. 2023 - 09:30</td>
              <td className="p-4 text-sm text-slate-600">4.5</td>
              <td className="p-4 text-sm text-slate-600">ผู้ดูแลระบบ 2</td>
            </tr>
          </tbody>
        </table>
      </div>
