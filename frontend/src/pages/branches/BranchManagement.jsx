    ...
    <div className="p-6">
      ...
      <div className="bg-white p-4 rounded-lg shadow-sm border border-slate-200 mb-6 flex gap-4">
        <div className="relative flex-1 max-w-md">
          ...
          <input type="text" placeholder="ค้นหาสาขา..." className="pl-9 w-full rounded-md border border-slate-300 p-2 text-sm focus:border-blue-500 focus:ring-blue-500" />
        </div>
      </div>
            ...
            <tr className="border-b border-slate-100 hover:bg-slate-50">
              <td className="p-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="font-medium text-slate-800">สาขาเซ็นทรัลพลาซา</div>
                    <div className="text-xs text-slate-500">BR-001</div>
                  </div>
                </div>
              </td>
              <td className="p-4 text-sm text-slate-600">สมศรี ม.</td>
              <td className="p-4 text-sm text-slate-500">กรุงเทพมหานคร</td>
            ...
            <tr className="border-b border-slate-100 hover:bg-slate-50">
              <td className="p-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="font-medium text-slate-800">สาขานอร์ทพอยท์</div>
                    <div className="text-xs text-slate-500">BR-002</div>
                  </div>
                </div>
              </td>
              <td className="p-4 text-sm text-slate-600">มานะ ด.</td>
              <td className="p-4 text-sm text-slate-500">เชียงใหม่</td>
